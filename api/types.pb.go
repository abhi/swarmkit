...
type NetworkAttachmentConfig struct {
	...
	DriverOpt map[string]string `protobuf:"bytes,4,rep,name=driverOpt" json:"driverOpt,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
}
...
func (m *NetworkAttachmentConfig) CopyFrom(src interface{}) {
	...
	*m = *o
	...
	if o.DriverOpt != nil {
		m.DriverOpt = make(map[string]string, len(o.DriverOpt))
		for k, v := range o.DriverOpt {
			m.DriverOpt[k] = v
		}
	}
...
func (m *NetworkAttachmentConfig) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.DriverOpt) > 0 {
		for k, _ := range m.DriverOpt {
			dAtA[i] = 0x22
			i++
			v := m.DriverOpt[k]
			mapSize := 1 + len(k) + sovTypes(uint64(len(k))) + 1 + len(v) + sovTypes(uint64(len(v)))
...
func (this *NetworkAttachmentConfig) String() string {
	...
	keysForDriverOpt := make([]string, 0, len(this.DriverOpt))
	for k, _ := range this.DriverOpt {
		keysForDriverOpt = append(keysForDriverOpt, k)
	}
	github_com_gogo_protobuf_sortkeys.Strings(keysForDriverOpt)
	mapStringForDriverOpt := "map[string]string{"
	for _, k := range keysForDriverOpt {
		mapStringForDriverOpt += fmt.Sprintf("%v: %v,", k, this.DriverOpt[k])
	}
	mapStringForDriverOpt += "}"
	s := strings.Join([]string{`&NetworkAttachmentConfig{`,
		`Target:` + fmt.Sprintf("%v", this.Target) + `,`,
		`Aliases:` + fmt.Sprintf("%v", this.Aliases) + `,`,
		`Addresses:` + fmt.Sprintf("%v", this.Addresses) + `,`,
		`DriverOpt:` + mapStringForDriverOpt + `,`,
		`}`,
	}, "")
	return s
}
...
func (m *NetworkAttachmentConfig) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field DriverOpt", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			iNdEx = postStringIndexmapkey
			if m.DriverOpt == nil {
				m.DriverOpt = make(map[string]string)
			}
			if iNdEx < postIndex {
				var valuekey uint64
				for shift := uint(0); ; shift += 7 {
...
var fileDescriptorTypes = []byte{
	...
	,
}
